...
public interface DisponibilidadRepository extends JpaRepository<DisponibilidadEntity, DisponibilidadPK> {
    ...
    // Read: Get one, le pasamos idVehiculo e idFranja por parametro
    ...
    // Update
    // En este caso solo se podrían actualizar atributos adicionales, 
    // pero como la entidad no tiene más campos, este método se deja como ejemplo
    @Modifying
    @Transactional
